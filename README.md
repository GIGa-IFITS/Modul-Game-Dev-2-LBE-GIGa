...
### Belajar UI
Untuk membuat user interface unity sudah memberikan beberapa component untuk memudahkan kita. Berikut adalah beberapa komponen yang dapat digunakan.
...
Untuk menambahkan scene, dapat menggunakan tombol add open scene atau menggunakan *drag and drop* scene di project tab ke area tersebut.
